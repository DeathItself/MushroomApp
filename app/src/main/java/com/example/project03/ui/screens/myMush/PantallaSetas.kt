...
fun MyMushroomList(mushrooms: List<MyMushroom>, navController: NavController) {
                                        ...
                                        CoroutineScope(Dispatchers.IO).launch {
                                            isDeleted =
                                                FirebaseFirestore.getInstance().deleteMushroom(
                                                    mushroom.commonName, mushroom.commentary
                                                )
                                        }
                                        navController.navigate(AppScreens.MisSetasScreen.route)
                                    }) {
    ...
    if (isDeleted == "true") {
        ...
        Toast.makeText(navController.context, "Error al eliminar seta", Toast.LENGTH_SHORT)
            .show()
    }
}